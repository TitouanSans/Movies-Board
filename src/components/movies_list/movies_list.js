...
import movies_card from '../movies_card/movies_card.js';

class movies_list extends React.Component {
    state = {
    ...
    search = event => {
        ...
        axios
            ...
            .then(res => {
                ...
                const movies_list = res.Search.map(movie => movie.imdbID);
                this.setState({
                    movies_list
                });
            });
            ...
            <div>
                ...
                {movies_list.length > 0 ? (
                    movies_list.map(movie => (
                        <movies_card movieID={movie} key={movie} />
                    ))
                ) : (
                    <p>
